...
const createSendToken = (user, statusCode, res) => {
	...
	if (process.env.NODE_ENV === 'production') cookieOptions.secure = true; //only sent when secure connection "https://"
...
exports.protect = catchAsync(async (req, res, next) => {
	...
	if (currentUser.changePasswordAfter(decoded.iat)) {
		return next(new AppError('user change password! Please log in again', 401));
	}
