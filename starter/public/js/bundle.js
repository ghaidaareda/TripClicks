      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlerts)('success', 'Login successfuly');
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlerts)('error', 'Error logging out , try again!');
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlerts)('success', 'Signup successful!');
          }
          console.log(res);
          _context3.next = 12;
          break;
        case 9:
          ...
          (0, _alerts.showAlerts)('error', _context3.t0.response.data.message);
        case 12:
        case "end":
...
if (signUpForm) signUpForm.addEventListener('submit', function (e) {
  ...
  (0, _login.signup)(name, email, password, passwordConfirmation);
});
