...
const tourSchema = new mongoose.Schema(
	{
		...
		priceDiscount: {
			...
			validate: {
				...
				message: 'discount ({VALUE})must be below the price',
			},
		},
		summary: {
			type: String,
...
// embeded to return usersguide in the tourschemia:
...
tourSchema.post(/^find/, function (docs, next) {
	console.log(`Quey took ${Date.now() - this.start} miliseconds to complete`);
	//console.log(docs);
	next();
});
